...
fetch('https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png').then(r => r.arrayBuffer()).then(buffer => {
  const image = dataImagePng.fromFile(buffer);
  image.decodePixels();
